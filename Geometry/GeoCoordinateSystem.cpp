...
class WktFileParser
	...
	/* Elements: */
	public:
	static const char* parseErrorStrings[NUM_PARSEERRORS]; // Descriptive strings for parsing errors
	private:
...
/**************************************
Static elements of class WktFileParser:
**************************************/

const char* WktFileParser::parseErrorStrings[WktFileParser::NUM_PARSEERRORS]=
	{
	...
	"Unknown keyword",
	"Semantic error",
	"Unsupported WKT format feature"
	};
...
GeoCoordinateSystemPtr parseProjectionFile(IO::DirectoryPtr directory,const char* projectionFileName)
	...
	try
		...
		throw Misc::makeStdErr(__PRETTY_FUNCTION__,"%s in projection file %s",WktFileParser::parseErrorStrings[err],name.c_str());
		}
