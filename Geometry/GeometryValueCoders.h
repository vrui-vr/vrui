...
template <>
class ValueCoder<Geometry::LinearUnit>
	{
	/* Methods: */
	public:
	static std::string encode(const Geometry::LinearUnit& value);
	static Geometry::LinearUnit decode(const char* start,const char* end,const char** decodeEnd =0);
	};
