...
/********************************************
Static elements of class MaterialLibraryNode:
********************************************/

const char* MaterialLibraryNode::className="MaterialLibrary";
...
void MaterialLibraryNode::read(SceneGraphReader& reader)
	{
	/*********************************************************************
	This is never actually called, because this node type only appears as
	a field in a MeshFile node, which doesn't write its fields. Duh.
	*********************************************************************/
	}

void MaterialLibraryNode::write(SceneGraphWriter& writer) const
	{
	/*********************************************************************
	This is never actually called, because this node type only appears as
	a field in a MeshFile node, which doesn't write its fields. Duh.
