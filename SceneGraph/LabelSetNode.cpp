...
/*************************************
Static elements of class LabelSetNode:
*************************************/

const char* LabelSetNode::className="LabelSet";
...
void LabelSetNode::read(SceneGraphReader& reader)
	{
...
void LabelSetNode::write(SceneGraphWriter& writer) const
	{
	/* Call the base class method: */
...
bool LabelSetNode::canCollide(void) const
	{
	return false;
	}

int LabelSetNode::getGeometryRequirementMask(void) const
	{
	return BaseAppearanceNode::HasSurfaces|BaseAppearanceNode::HasTwoSidedSurfaces;
	}
...
void LabelSetNode::testCollision(SphereCollisionQuery& collisionQuery) const
	{
	/* Not implemented yet: */
	}

void LabelSetNode::glRenderAction(int appearanceRequirementsMask,GLRenderState& renderState) const
	{
