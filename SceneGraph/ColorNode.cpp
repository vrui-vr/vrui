...
/**********************************
Static elements of class ColorNode:
**********************************/

const char* ColorNode::className="Color";
...
void ColorNode::read(SceneGraphReader& reader)
	{
	/* Read all fields: */
	reader.readSFNode(colorMap);
	reader.readField(colorScalar);
	reader.readField(color);
	}

void ColorNode::write(SceneGraphWriter& writer) const
	{
	/* Write all fields: */
	writer.writeSFNode(colorMap);
	writer.writeField(colorScalar);
