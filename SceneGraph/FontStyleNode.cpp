...
/**************************************
Static elements of class FontStyleNode:
**************************************/

const char* FontStyleNode::className="FontStyle";
...
void FontStyleNode::read(SceneGraphReader& reader)
	{
	/* Read all fields: */
...
void FontStyleNode::write(SceneGraphWriter& writer) const
	{
	/* Write all fields: */
