...
/*********************************
Static elements of class TextNode:
*********************************/

const char* TextNode::className="Text";
...
void TextNode::read(SceneGraphReader& reader)
	{
...
void TextNode::write(SceneGraphWriter& writer) const
	{
	/* Call the base class method: */
...
bool TextNode::canCollide(void) const
	{
	return false;
	}

int TextNode::getGeometryRequirementMask(void) const
	{
...
void TextNode::testCollision(SphereCollisionQuery& collisionQuery) const
	{
	/* Not implemented yet: */
	}

void TextNode::glRenderAction(int appearanceRequirementsMask,GLRenderState& renderState) const
	{
