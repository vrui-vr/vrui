...
/*************************************
Static elements of class ColorMapNode:
*************************************/

const char* ColorMapNode::className="ColorMap";
...
void ColorMapNode::read(SceneGraphReader& reader)
	{
	/* Read all fields: */
	reader.readField(scalar);
	reader.readField(color);
	}

void ColorMapNode::write(SceneGraphWriter& writer) const
	{
	/* Write all fields: */
	writer.writeField(scalar);
