...
/*********************************************
Static elements of class TextureTransformNode:
*********************************************/

const char* TextureTransformNode::className="TextureTransform";
...
void TextureTransformNode::read(SceneGraphReader& reader)
	{
	/* Read all fields: */
...
void TextureTransformNode::write(SceneGraphWriter& writer) const
	{
	/* Write all fields: */
