...
/***************************************
Static elements of class CoordinateNode:
***************************************/

const char* CoordinateNode::className="Coordinate";
...
void CoordinateNode::read(SceneGraphReader& reader)
	{
	/* Read all fields: */
	reader.readField(point);
	}

void CoordinateNode::write(SceneGraphWriter& writer) const
	{
	/* Write all fields: */
