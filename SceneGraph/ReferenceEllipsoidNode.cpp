...
/***********************************************
Static elements of class ReferenceEllipsoidNode:
***********************************************/

const char* ReferenceEllipsoidNode::className="ReferenceEllipsoid";
...
void ReferenceEllipsoidNode::read(SceneGraphReader& reader)
	{
	/* Read all fields: */
	reader.readField(radius);
	reader.readField(flattening);
	reader.readField(scale);
	}

void ReferenceEllipsoidNode::write(SceneGraphWriter& writer) const
	{
	/* Write all fields: */
	writer.writeField(radius);
	writer.writeField(flattening);
