...
/*********************************
Static elements of class ConeNode:
*********************************/

const char* ConeNode::className="Cone";
...
void ConeNode::read(SceneGraphReader& reader)
	{
	...
	reader.readField(bottomRadius);
	reader.readField(numSegments);
	reader.readField(side);
	reader.readField(bottom);
	}

void ConeNode::write(SceneGraphWriter& writer) const
	{
	/* Call the base class method: */
	...
	writer.writeField(bottomRadius);
	writer.writeField(numSegments);
	writer.writeField(side);
	writer.writeField(bottom);
	}

bool ConeNode::canCollide(void) const
	{
	return false;
	}

int ConeNode::getGeometryRequirementMask(void) const
	{
...
void ConeNode::testCollision(SphereCollisionQuery& collisionQuery) const
	{
	/* Not implemented yet: */
	}

void ConeNode::glRenderAction(int appearanceRequirementsMask,GLRenderState& renderState) const
	{
	/* Set up OpenGL state: */
