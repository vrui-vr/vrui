...
class VisletManager:public Plugins::FactoryManager<VisletFactory>
	...
	/* Private methods: */
	void setVisletState(const std::string& visletClassName,int visletIndex,bool newState);
	static void addVisletCommandCallback(const char* argumentBegin,const char* argumentEnd,void* userData);
	static void removeVisletCommandCallback(const char* argumentBegin,const char* argumentEnd,void* userData);
	static void enableVisletCommandCallback(const char* argumentBegin,const char* argumentEnd,void* userData);
	static void disableVisletCommandCallback(const char* argumentBegin,const char* argumentEnd,void* userData);
