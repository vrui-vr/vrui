...
class ViewSpecification
	...
	/* Elements: */
	private:
	ISize viewportSize; // Size of window's viewport in pixels
	...
	/* Methods: */
	public:
	void setViewportSize(const ISize& newViewportSize) // Sets viewport size
		{
	...
	const ISize& getViewportSize(void) const // Returns viewport size as array
		{
		return viewportSize;
		}
