...
class Vislet
	...
	virtual void disable(bool shutdown); // Disables the vislet; called for the last time, with shutdown==true, after the end of Vrui's main loop even if vislet is non-active at that time
