...
void UserInterfaceToolFactory::Configuration::read(const Misc::ConfigurationFileSection& cfs)
	{
	cfs.updateValue("./drawRay",drawRay);
	cfs.updateValue("./rayColor",rayColor);
	cfs.updateValue("./rayWidth",rayWidth);
	}

void UserInterfaceToolFactory::Configuration::write(Misc::ConfigurationFileSection& cfs) const
	{
	cfs.storeValue("./drawRay",drawRay);
	cfs.storeValue("./rayColor",rayColor);
	cfs.storeValue("./rayWidth",rayWidth);
	}
