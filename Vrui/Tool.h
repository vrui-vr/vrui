...
class Tool
	...
	virtual void display(GLContextData& contextData) const; // Method for rendering the tool's current state into the given OpenGL context
	virtual void sound(ALContextData& contextData) const; // Method for rendering the tool's current sound state into the given OpenAL context
	};
