...
class ClipPlaneManager
	...
	void setClipPlanes(DisplayState* displayState,GLContextData& contextData,bool enable =true) const; // Sets the clipping planes in the current OpenGL context; enables planes if flag is true, otherwise starts in paused mode
