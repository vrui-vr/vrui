...
class LocatorTool:public Tool
	...
	class MotionCallbackData:public Misc::CallbackData
		...
		NavTrackerState currentTransformation; // Current motion transformation
	...
	class ButtonPressCallbackData:public Misc::CallbackData
		...
		public:
		LocatorTool* tool; // Pointer to the tool causing the event
		NavTrackerState currentTransformation; // Transformation at the moment the button was pressed
	...
	class ButtonReleaseCallbackData:public Misc::CallbackData
		...
		public:
		LocatorTool* tool; // Pointer to the tool causing the event
		NavTrackerState currentTransformation; // Transformation at the moment the button was released
