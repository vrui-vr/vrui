...
class VRScreen
	...
	/* Private methods: */
	static void setDeviceCallback(const char* argumentsBegin,const char* argumentsEnd,void* userData);
	static void setTransformCallback(const char* argumentsBegin,const char* argumentsEnd,void* userData);
