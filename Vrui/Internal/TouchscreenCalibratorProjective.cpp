...
/************************************************
Methods of class TouchscreenCalibratorProjective:
************************************************/

TouchscreenCalibratorProjective::TouchscreenCalibratorProjective(const TouchscreenCalibrator::Box& rawDomain,const std::vector<TouchscreenCalibrator::TiePoint>& tiePoints)
	{
...
TouchscreenCalibratorProjective::TouchscreenCalibratorProjective(const Misc::ConfigurationFileSection& configFileSection)
	{
	try
		{
...
void TouchscreenCalibratorProjective::writeConfig(Misc::ConfigurationFileSection& configFileSection) const
	{
	try
		{
...
TouchscreenCalibrator::Point TouchscreenCalibratorProjective::calibrate(const TouchscreenCalibrator::Point& raw) const
	{
