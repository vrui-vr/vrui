...
class InputDeviceAdapterMouse:public InputDeviceAdapter
	...
	GLWindow::Offset lockedMousePos; // Mouse pointer position at time of locking in window coordinates
	...
	void setMousePosition(VRWindow* newWindow,const GLWindow::Offset& newMouse); // Sets current mouse position in window (pixel) coordinates of given window
