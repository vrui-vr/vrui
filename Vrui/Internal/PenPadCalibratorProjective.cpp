...
/*******************************************
Methods of class PenPadCalibratorProjective:
*******************************************/

PenPadCalibratorProjective::PenPadCalibratorProjective(const PenPadCalibrator::TiePointList& tiePoints,const PenPadCalibrator::Box2& rawDomain,Misc::ConfigurationFileSection& configFileSection)
	{
	...
	/* Set up a projective point aligner from normalized raw space: */
	...
	transform.getMatrix()/=transform.getMatrix()(2,2);
	
	/* Write the solution in normalized raw space: */
	try
		{
		/* Write the type of this calibrator: */
		configFileSection.storeString("./calibratorType","Projective");
...
PenPadCalibratorProjective::PenPadCalibratorProjective(const Misc::ConfigurationFileSection& configFileSection,const PenPadCalibrator::Box2& rawDomain)
	{
	try
		{
...
PenPadCalibrator::Point2 PenPadCalibratorProjective::calibrate(const PenPadCalibrator::Point2& raw) const
	{
