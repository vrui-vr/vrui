...
void UIManagerFree::projectDevice(InputDevice* device,const TrackerState& proposedTransform) const
	{
	/* Assign the proposed transformation to the device without change: */
	device->setTransformation(proposedTransform);
	}
