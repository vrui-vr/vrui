...
struct WindowProperties
	...
	bool nonlinear; // Flag whether the main color buffer shall contain non-linear compressed color values using sRGB
	...
	void setNonlinear(bool newNonlinear); // Enables or disables non-linear compressed color values in the main color buffer
	...
	void setContextProperties(GLContext::Properties& contextProperties) const; // Updates the given OpenGL context properties with this property set
	};
