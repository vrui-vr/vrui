...
void SixAxisTransformToolFactory::Configuration::load(const Misc::ConfigurationFileSection& cfs)
	...
	cfs.updateValue("./deviceGlyphType",deviceGlyphType);
	cfs.updateValue("./deviceGlyphMaterial",deviceGlyphMaterial);
	}
...
void SixAxisTransformToolFactory::Configuration::save(Misc::ConfigurationFileSection& cfs) const
	...
	cfs.storeValue("./deviceGlyphType",deviceGlyphType);
	cfs.storeValue("./deviceGlyphMaterial",deviceGlyphMaterial);
	}
