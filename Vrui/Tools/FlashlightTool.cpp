...
void FlashlightToolFactory::Configuration::read(const Misc::ConfigurationFileSection& cfs)
	{
	cfs.updateValue("./lightColor",light.diffuse);
	light.specular=light.diffuse;
	cfs.updateValue("./lightSpotCutoff",light.spotCutoff);
	cfs.updateValue("./lightSpotExponent",light.spotExponent);
	}

void FlashlightToolFactory::Configuration::write(Misc::ConfigurationFileSection& cfs) const
	{
	cfs.storeValue("./lightColor",light.diffuse);
	cfs.storeValue("./lightSpotCutoff",light.spotCutoff);
	cfs.storeValue("./lightSpotExponent",light.spotExponent);
	}
