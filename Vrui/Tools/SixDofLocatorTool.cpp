...
void SixDofLocatorTool::buttonCallback(int,InputDevice::ButtonCallbackData* cbData)
	...
	if(cbData->newButtonState) // Button has just been pressed
		...
		ButtonPressCallbackData cbData(this,getDeviceTransformation(getButtonDevice(0)));
		buttonPressCallbacks.call(&cbData);
		}
	else // Button has just been released
		{
		/* Call button release callbacks: */
		ButtonReleaseCallbackData cbData(this,getDeviceTransformation(getButtonDevice(0)));
...
void SixDofLocatorTool::frame(void)
	...
	MotionCallbackData cbData(this,getDeviceTransformation(getButtonDevice(0)));
