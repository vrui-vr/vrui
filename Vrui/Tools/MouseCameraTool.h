...
class MouseCameraToolFactory:public ToolFactory
	...
	struct Configuration // Structure containing tool settings
		...
		bool keepScreenLevel; // Flag whether to keep the virtual camera's view level when tracking the main viewer
		Scalar fovScale; // Scale factor to widen the field of view when tracking the main viewer
...
class MouseCameraTool:public UtilityTool
	...
	Scalar eyeScreenDist; // Initial distance of viewer's eye from screen
