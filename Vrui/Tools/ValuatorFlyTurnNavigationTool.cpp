...
ValuatorFlyTurnNavigationToolFactory::ValuatorFlyTurnNavigationToolFactory(ToolManager& toolManager)
	...
	cfs.updateValue("./valuatorThreshold",valuatorThreshold);
	cfs.updateValue("./valuatorExponent",valuatorExponent);
	cfs.updateValue("./superAccelerationFactor",superAccelerationFactor);
	cfs.updateValue("./flyDirectionDeviceCoordinates",flyDirectionDeviceCoordinates);
	cfs.updateValue("./flyDirection",flyDirection);
	flyDirection.normalize();
	cfs.updateValue("./flyFactor",flyFactor);
	cfs.updateValue("./rotationAxisDeviceCoordinates",rotationAxisDeviceCoordinates);
	cfs.updateValue("./rotationAxis",rotationAxis);
	rotationAxis.normalize();
	cfs.updateValue("./rotationCenterDeviceCoordinates",rotationCenterDeviceCoordinates);
	cfs.updateValue("./rotationCenter",rotationCenter);
	rotationFactor=Math::rad(cfs.retrieveValue("./rotationFactor",rotationFactor));
