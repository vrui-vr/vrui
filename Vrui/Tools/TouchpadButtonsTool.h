...
class TouchpadButtonsToolFactory:public ToolFactory
	...
	struct Configuration // Structure containing tool settings
		...
		Scalar centerRadius; // Central radius in touchpad coordinates around which buttons are arranged
		...
		Color touchpadColor; // Color to draw the touchpad's visual representation
