...
ShiftButtonToolFactory::ShiftButtonToolFactory(ToolManager& toolManager)
	...
	cfs.updateValue("./toggle",toggle);
	cfs.updateValue("./forwardShiftButton",forwardShiftButton);
...
void ShiftButtonTool::configure(const Misc::ConfigurationFileSection& configFileSection)
	{
	/* Read settings: */
	configFileSection.updateValue("./toggle",toggle);
	configFileSection.updateValue("./forwardShiftButton",forwardShiftButton);
	configFileSection.updateValue("./resetFeatures",resetFeatures);
	}

void ShiftButtonTool::storeState(Misc::ConfigurationFileSection& configFileSection) const
	{
	/* Write settings: */
	configFileSection.storeValue("./toggle",toggle);
	configFileSection.storeValue("./forwardShiftButton",forwardShiftButton);
	configFileSection.storeValue("./resetFeatures",resetFeatures);
	}
