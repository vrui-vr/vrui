...
void FPSNavigationToolFactory::Configuration::load(const Misc::ConfigurationFileSection& cfs)
	...
	cfs.updateValue("./moveSpeeds",moveSpeeds);
	cfs.updateValue("./fallAcceleration",fallAcceleration);
	cfs.updateValue("./jumpVelocity",jumpVelocity);
	cfs.updateValue("./probeSize",probeSize);
	cfs.updateValue("./maxClimb",maxClimb);
	azimuthStep=Math::rad(cfs.retrieveValue("./azimuthStep",Math::deg(azimuthStep)));
	cfs.updateValue("./fixAzimuth",fixAzimuth);
	cfs.updateValue("./levelOnExit",levelOnExit);
	cfs.updateValue("./drawHud",drawHud);
	cfs.updateValue("./drawElevation",drawElevation);
...
void FPSNavigationToolFactory::Configuration::save(Misc::ConfigurationFileSection& cfs) const
	...
	cfs.storeValue("./moveSpeeds",moveSpeeds);
	cfs.storeValue("./fallAcceleration",fallAcceleration);
	cfs.storeValue("./jumpVelocity",jumpVelocity);
	cfs.storeValue("./probeSize",probeSize);
	cfs.storeValue("./maxClimb",maxClimb);
	cfs.storeValue("./azimuthStep",Math::deg(azimuthStep));
	cfs.storeValue("./fixAzimuth",fixAzimuth);
	cfs.storeValue("./levelOnExit",levelOnExit);
	cfs.storeValue("./drawHud",drawHud);
	cfs.storeValue("./drawElevation",drawElevation);
