...
void SixAxisSurfaceNavigationToolFactory::Configuration::load(const Misc::ConfigurationFileSection& cfs)
	...
	cfs.updateValue("./translateFactors",translateFactors);
	cfs.updateValue("./rotateFactors",rotateFactors);
	cfs.updateValue("./canRoll",canRoll);
	cfs.updateValue("./bankTurns",bankTurns);
	cfs.updateValue("./bankFactor",bankFactor);
	cfs.updateValue("./levelSpeed",levelSpeed);
	if(levelSpeed<Scalar(0))
		levelSpeed=Scalar(0);
	cfs.updateValue("./canFly",canFly);
...
void SixAxisSurfaceNavigationToolFactory::Configuration::save(Misc::ConfigurationFileSection& cfs) const
	...
	cfs.storeValue("./translateFactors",translateFactors);
	cfs.storeValue("./rotateFactors",rotateFactors);
	cfs.storeValue("./canRoll",canRoll);
	cfs.storeValue("./bankTurns",bankTurns);
	cfs.storeValue("./bankFactor",bankFactor);
	cfs.storeValue("./levelSpeed",levelSpeed);
	cfs.storeValue("./canFly",canFly);
