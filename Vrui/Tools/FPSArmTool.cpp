...
void FPSArmToolFactory::Configuration::read(const Misc::ConfigurationFileSection& cfs)
	{
	cfs.updateValue("./lowPosition",lowPosition);
	cfs.updateValue("./highPosition",highPosition);
	cfs.updateValue("./transitionTime",transitionTime);
	cfs.updateValue("./followPitch",followPitch);
	cfs.updateValue("./followYaw",followYaw);
	}

void FPSArmToolFactory::Configuration::write(Misc::ConfigurationFileSection& cfs) const
	{
	cfs.storeValue("./lowPosition",lowPosition);
	cfs.storeValue("./highPosition",highPosition);
	cfs.storeValue("./transitionTime",transitionTime);
	cfs.storeValue("./followPitch",followPitch);
	cfs.storeValue("./followYaw",followYaw);
	}
