...
void HelicopterNavigationToolFactory::Configuration::load(const Misc::ConfigurationFileSection& cfs)
	...
	cfs.updateValue("./rotateFactors",rotateFactors);
	cfs.updateValue("./g",g);
	cfs.updateValue("./collectiveMin",collectiveMin);
	cfs.updateValue("./collectiveMax",collectiveMax);
	cfs.updateValue("./thrust",thrust);
	cfs.updateValue("./brake",brake);
	cfs.updateValue("./dragCoefficients",dragCoefficients);
	for(int i=0;i<3;++i)
		dragCoefficients[i]=-Math::abs(dragCoefficients[i]);
	cfs.updateValue("./viewAngleFactors",viewAngleFactors);
	cfs.updateValue("./probeSize",probeSize);
	cfs.updateValue("./maxClimb",maxClimb);
	cfs.updateValue("./drawHud",drawHud);
	cfs.updateValue("./hudColor",hudColor);
	cfs.updateValue("./hudDist",hudDist);
...
void HelicopterNavigationToolFactory::Configuration::save(Misc::ConfigurationFileSection& cfs) const
	...
	cfs.storeValue("./rotateFactors",rotateFactors);
	cfs.storeValue("./g",g);
	cfs.storeValue("./collectiveMin",collectiveMin);
	cfs.storeValue("./collectiveMax",collectiveMax);
	cfs.storeValue("./thrust",thrust);
	cfs.storeValue("./brake",brake);
	cfs.storeValue("./dragCoefficients",dragCoefficients);
	cfs.storeValue("./viewAngleFactors",viewAngleFactors);
	cfs.storeValue("./probeSize",probeSize);
	cfs.storeValue("./maxClimb",maxClimb);
	cfs.storeValue("./drawHud",drawHud);
	cfs.storeValue("./hudColor",hudColor);
	cfs.storeValue("./hudDist",hudDist);
