...
ComeHitherNavigationToolFactory::ComeHitherNavigationToolFactory(ToolManager& toolManager)
	...
	cfs.updateValue("./linearSnapThreshold",linearSnapThreshold);
	cfs.updateValue("./angularSnapThreshold",angularSnapThreshold);
	angularSnapThreshold=Math::rad(angularSnapThreshold);
	cfs.updateValue("./maxLinearVelocity",maxLinearVelocity);
	cfs.updateValue("./maxAngularVelocity",maxAngularVelocity);
	maxAngularVelocity=Math::rad(maxAngularVelocity);
...
void ComeHitherNavigationTool::buttonCallback(int,InputDevice::ButtonCallbackData* cbData)
	...
	if(cbData->newButtonState) // Button has just been pressed
		...
		if(isActive()) // Tool is already active
			...
			setNavigationTransformation(targetNav,getDisplayCenter());
