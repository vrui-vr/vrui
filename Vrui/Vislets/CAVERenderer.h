...
class CAVERenderer:public Vislet,public SceneGraph::GraphNode,public GLObject
	{
	...
	struct DataItem:public GLObject::DataItem
		...
		GLuint screenDisplayListId; // Display list to render a CAVE screen
	...
	static const char* className; // Name of the scene graph node class
	...
	/* Private methods: */
	void renderScreen(void) const; // Renders one of the CAVE's screens
