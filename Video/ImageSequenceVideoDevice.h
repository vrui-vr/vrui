...
class ImageSequenceVideoDevice:public VideoDevice
	...
	std::string frameNameTemplate; // The name template for all frame image files
	Size frameSize; // Frame size of all frame images
	...
	Threads::Mutex currentFrameMutex; // Mutex protecting the current frame
	Images::BaseImage currentFrame; // The current frame
	FrameBuffer currentBuffer; // A frame buffer representing the current frame
	Threads::Thread refreshThread; // Thread to generate fake streaming events
	...
	void* refreshThreadMethod(void); // Thread method to generate fake streaming events
