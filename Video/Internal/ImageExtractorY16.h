...
#ifndef VIDEO_IMAGEEXTRACTORY16_INCLUDED
#define VIDEO_IMAGEEXTRACTORY16_INCLUDED

#include <Video/ImageExtractor.h>

namespace Video {

class ImageExtractorY16:public ImageExtractor
	{
	/* Constructors and destructors: */
	public:
	ImageExtractorY16(const Size& sSize); // Constructs an extractor for the given frame size
