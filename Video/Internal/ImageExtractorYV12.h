...
class ImageExtractorYV12:public ImageExtractor
	...
	public:
	ImageExtractorYV12(const Size& sSize,ptrdiff_t ypOffset,ptrdiff_t ypStride,ptrdiff_t cbOffset,ptrdiff_t cbStride,ptrdiff_t crOffset,ptrdiff_t crStride); // Constructs an extractor for the given frame size and plane layout
