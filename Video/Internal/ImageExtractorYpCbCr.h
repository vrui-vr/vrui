...
#ifndef VIDEO_IMAGEEXTRACTORYPCBCR_INCLUDED
#define VIDEO_IMAGEEXTRACTORYPCBCR_INCLUDED

#include <Video/ImageExtractor.h>

namespace Video {

class ImageExtractorYpCbCr:public ImageExtractor
	{
	/* Constructors and destructors: */
	public:
	ImageExtractorYpCbCr(const Size& sSize); // Constructs an extractor for the given frame size
