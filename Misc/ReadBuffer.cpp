...
ReadBuffer::ReadError::ReadError(const char* source,size_t numBytes,size_t numBytesRead)
	:std::runtime_error(makeStdErrMsg(source,"Error reading %u bytes from buffer, read %u bytes instead",numBytes,numBytesRead))
	{
	}
