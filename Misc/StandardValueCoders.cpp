...
long int parseSignedInteger(const char* start,const char* end,const char** decodeEnd)
	{
	long int result=0;
...
unsigned long int parseUnsignedInteger(const char* start,const char* end,const char** decodeEnd)
	{
	...
	while(cPtr!=end&&*cPtr>='0'&&*cPtr<='9')
		{
		result*=10;
		result+=(long unsigned int)(*cPtr-'0');
		haveDigit=true;
		++cPtr;
		}
...
int ValueCoder<int>::decode(const char* start,const char* end,const char** decodeEnd)
	...
	try
		{
		return int(parseSignedInteger(start,end,decodeEnd));
		}
	catch(...)
		{
		/* Re-throw the exception with a meaningful error string: */
...
unsigned int ValueCoder<unsigned int>::decode(const char* start,const char* end,const char** decodeEnd)
	...
	try
		{
		return (unsigned int)(parseUnsignedInteger(start,end,decodeEnd));
		}
	catch(...)
		{
		/* Re-throw the exception with a meaningful error string: */
...
/*************************************
Methods of class ValueCoder<long int>:
*************************************/

std::string ValueCoder<long int>::encode(const long int& value)
	{
	char buffer[22];
	return std::string(print(value,buffer+21));
	}

long int ValueCoder<long int>::decode(const char* start,const char* end,const char** decodeEnd)
	{
	try
		{
		...
		{
		/* Re-throw the exception with a meaningful error string: */
		throw DecodingError(std::string("Unable to convert \"")+std::string(start,end)+std::string("\" to long int"));
		}
	}

/**********************************************
Methods of class ValueCoder<long unsigned int>:
**********************************************/

std::string ValueCoder<long unsigned int>::encode(const long unsigned int& value)
	{
	char buffer[21];
	return std::string(print(value,buffer+20));
	}

long unsigned int ValueCoder<long unsigned int>::decode(const char* start,const char* end,const char** decodeEnd)
	{
	try
		{
		...
		{
		/* Re-throw the exception with a meaningful error string: */
		throw DecodingError(std::string("Unable to convert \"")+std::string(start,end)+std::string("\" to long unsigned int"));
		}
	}
