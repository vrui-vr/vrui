...
inline bool mustSwapEndianness(Endianness endianness) // Returns true if the given endianness requires a swap on the current host
	{
	#if __BYTE_ORDER==__LITTLE_ENDIAN
	return endianness==Misc::BigEndian;
	#endif
	#if __BYTE_ORDER==__BIG_ENDIAN
	return endianness==Misc::LittleEndian;
	#endif
	}

/******************************************************************
Helper class to allow partial specialization of endianness swapper:
******************************************************************/
