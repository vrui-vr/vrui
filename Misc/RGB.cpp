...
template RGB<SInt8> blend(const RGB<SInt8>& c1,const RGB<SInt8>& c2,double blend);
...
template RGB<UInt8> blend(const RGB<UInt8>& c1,const RGB<UInt8>& c2,double blend);
...
template RGB<SInt16> blend(const RGB<SInt16>& c1,const RGB<SInt16>& c2,double blend);
...
template RGB<UInt16> blend(const RGB<UInt16>& c1,const RGB<UInt16>& c2,double blend);
...
template RGB<SInt32> blend(const RGB<SInt32>& c1,const RGB<SInt32>& c2,double blend);
...
template RGB<UInt32> blend(const RGB<UInt32>& c1,const RGB<UInt32>& c2,double blend);
...
template RGB<Float32> blend(const RGB<Float32>& c1,const RGB<Float32>& c2,double blend);
...
template RGB<Float64> blend(const RGB<Float64>& c1,const RGB<Float64>& c2,double blend);
