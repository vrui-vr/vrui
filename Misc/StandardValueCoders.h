...
template <>
class ValueCoder<long int>
	{
	/* Methods: */
	public:
	static std::string encode(const long int& value);
	static long int decode(const char* start,const char* end,const char** decodeEnd =0);
	};

template <>
class ValueCoder<long unsigned int>
	{
	/* Methods: */
	public:
	static std::string encode(const long unsigned int& value);
	static long unsigned int decode(const char* start,const char* end,const char** decodeEnd =0);
	};
