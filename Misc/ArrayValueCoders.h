...
template <class ComponentParam,unsigned int numComponentsParam>
class ValueCoder<IntVector<ComponentParam,numComponentsParam> >
	{
	/* Methods: */
	public:
	static std::string encode(const IntVector<ComponentParam,numComponentsParam>& value);
	static IntVector<ComponentParam,numComponentsParam> decode(const char* start,const char* end,const char** decodeEnd =0);
	};

template <unsigned int numComponentsParam>
class ValueCoder<Offset<numComponentsParam> >
	{
	/* Methods: */
	public:
	static std::string encode(const Offset<numComponentsParam>& value);
	static Offset<numComponentsParam> decode(const char* start,const char* end,const char** decodeEnd =0);
	};

template <unsigned int numComponentsParam>
class ValueCoder<Size<numComponentsParam> >
	{
	/* Methods: */
	public:
	static std::string encode(const Size<numComponentsParam>& value);
	static Size<numComponentsParam> decode(const char* start,const char* end,const char** decodeEnd =0);
	};

template <unsigned int numComponentsParam>
class ValueCoder<Rect<numComponentsParam> >
	{
	/* Methods: */
	public:
	static std::string encode(const Rect<numComponentsParam>& value);
	static Rect<numComponentsParam> decode(const char* start,const char* end,const char** decodeEnd =0);
	};
