...
class FunctionCall:public RefCounted
	{
	/* Embedded classes: */
	public:
...
class VoidMethodCall:public FunctionCall<ParameterParam>
	...
	virtual void operator()(Parameter parameter) const
		{
		/* Can't call non-const method from const function call object: */
		throw Misc::makeStdErr(__PRETTY_FUNCTION__,"Cannot call non-const method from const function call object");
		}
	virtual void operator()(Parameter parameter)
		{
