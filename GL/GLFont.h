...
class GLFont
	...
	void doUploadStringTexture(const char* string,GLsizei stringWidth,GLsizei textureWidth) const; // Creates and uploads a texture for a string
	void doUploadStringTexture(const char* string,GLsizei selectionStart,GLsizei selectionEnd,GLsizei stringWidth,GLsizei textureWidth) const; // Creates and uploads a texture for a string using the given selection range
	void doUploadStringTexture(const char* string,const Color& stringBackgroundColor,const Color& stringForegroundColor,GLsizei stringWidth,GLsizei textureWidth) const; // Creates and uploads a texture for a string using the given colors
	void doUploadStringTexture(const char* string,const Color& stringBackgroundColor,const Color& stringForegroundColor,GLsizei selectionStart,GLsizei selectionEnd,const Color& selectionBackgroundColor,const Color& selectionForegroundColor,GLsizei stringWidth,GLsizei textureWidth) const; // Creates and uploads a texture for a string using the given colors, selection range, and selection colors
	...
	void uploadStringTexture(const GLString& string) const // Ditto
		...
		doUploadStringTexture(string.string,string.texelWidth,string.textureWidth);
		}
	...
	void uploadStringTexture(const GLString& string,const Color& stringBackgroundColor,const Color& stringForegroundColor) const // Ditto
		{
		/* Upload the string's texture image: */
		doUploadStringTexture(string.string,stringBackgroundColor,stringForegroundColor,string.texelWidth,string.textureWidth);
		}
	void uploadStringTexture(const char* string,GLsizei selectionStart,GLsizei selectionEnd) const; // Uploads a string's texture image with the given selection range
	void uploadStringTexture(const GLString& string,GLsizei selectionStart,GLsizei selectionEnd) const // Ditto
		{
		/* Upload the string's texture image: */
		doUploadStringTexture(string.string,selectionStart,selectionEnd,string.texelWidth,string.textureWidth);
		}
	...
	void uploadStringTexture(const GLString& string,const Color& stringBackgroundColor,const Color& stringForegroundColor,GLsizei selectionStart,GLsizei selectionEnd,const Color& selectionBackgroundColor,const Color& selectionForegroundColor) const // Ditto
		{
		/* Upload the string's texture image: */
		doUploadStringTexture(string.string,stringBackgroundColor,stringForegroundColor,selectionStart,selectionEnd,selectionBackgroundColor,selectionForegroundColor,string.texelWidth,string.textureWidth);
		}
