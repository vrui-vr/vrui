...
#ifndef GLEXTENSIONS_GLARBCOPYBUFFER_INCLUDED
#define GLEXTENSIONS_GLARBCOPYBUFFER_INCLUDED
...
class GLARBCopyBuffer:public GLExtension
	{
	/* Elements: */
	private:
	static GL_THREAD_LOCAL(GLARBCopyBuffer*) current; // Pointer to extension object for current OpenGL context
	static const char* name; // Extension name
	PFNGLCOPYBUFFERSUBDATAPROC glCopyBufferSubDataProc;
	
	/* Constructors and destructors: */
	private:
	GLARBCopyBuffer(void);
	public:
	virtual ~GLARBCopyBuffer(void);
	...
	inline friend void glCopyBufferSubData(GLenum readTarget,GLenum writeTarget,GLintptr readOffset,GLintptr writeOffset,GLsizeiptr size)
		{
		GLARBCopyBuffer::current->glCopyBufferSubDataProc(readTarget,writeTarget,readOffset,writeOffset,size);
		}
	};
