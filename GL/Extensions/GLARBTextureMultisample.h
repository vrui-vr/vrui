...
inline void glTexImage2DMultisample(GLenum target,GLsizei samples,GLenum internalformat,const Misc::Size<2>& size,GLboolean fixedsamplelocations)
	{
	glTexImage2DMultisample(target,samples,internalformat,size[0],size[1],fixedsamplelocations);
	}
