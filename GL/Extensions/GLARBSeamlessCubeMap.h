...
#ifndef GLEXTENSIONS_GLARBSEAMLESSCUBEMAP_INCLUDED
#define GLEXTENSIONS_GLARBSEAMLESSCUBEMAP_INCLUDED
...
class GLARBSeamlessCubeMap:public GLExtension
	{
	/* Elements: */
	private:
	static GL_THREAD_LOCAL(GLARBSeamlessCubeMap*) current; // Pointer to extension object for current OpenGL context
	static const char* name; // Extension name
	
	/* Constructors and destructors: */
	private:
	GLARBSeamlessCubeMap(void);
	public:
	virtual ~GLARBSeamlessCubeMap(void);
