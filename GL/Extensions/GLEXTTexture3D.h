...
inline void glTexImage3DEXT(GLenum target,GLint level,GLenum internalformat,const Misc::Size<3>& size,GLint border,GLenum format,GLenum type,const GLvoid* pixels)
	{
	glTexImage3DEXT(target,level,internalformat,size[0],size[1],size[2],border,format,type,pixels);
	}

inline void glTexSubImage3DEXT(GLenum target,GLint level,const Misc::Rect<3> rect,GLenum format,GLenum type,const GLvoid* pixels)
	{
	glTexSubImage3DEXT(target,level,rect.offset[0],rect.offset[1],rect.offset[2],rect.size[0],rect.size[1],rect.size[2],format,type,pixels);
	}
