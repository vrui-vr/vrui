...
inline void glBlitFramebufferEXT(const Misc::Rect<2>& source,const Misc::Rect<2>& dest,GLbitfield mask,GLenum filter)
	{
	glBlitFramebufferEXT(source.offset[0],source.offset[1],source.offset[0]+source.size[0],source.offset[1]+source.size[1],dest.offset[0],dest.offset[1],dest.offset[0]+dest.size[0],dest.offset[1]+dest.size[1],mask,filter);
	}
