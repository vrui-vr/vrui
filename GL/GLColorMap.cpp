...
GLColorMap::GLColorMap(GLsizei numKeys,const GLColorMap::Color* colors,const GLdouble* keys,GLsizei sNumEntries)
...
GLColorMap& GLColorMap::setColors(GLsizei numKeys,const GLColorMap::Color* colors,const GLdouble* keys,GLsizei newNumEntries)
	{
...
void GLColorMap::save(const char* fileName) const
	...
	if(numEntries!=256)
		throw Misc::makeStdErr(__PRETTY_FUNCTION__,"Cannot save color map with more or less than 256 entries");
