...
class ALObject
	...
	struct DataItem // Base class for context data items
		...
		/* Methods: */
		virtual void shutdown(void); // Called to release dependencies on other OpenAL resources (such as sources releasing buffers) before an OpenAL context is destroyed
		};
