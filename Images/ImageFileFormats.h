...
enum ImageFileFormat // Enumerated type for potentially supported image file formats
	...
	IFF_GIF, // GIF (Graphics Interchange Format) images, always supported
	...
	IFF_IFF, // IFF (Interchange File Format) images, always supported
	IFF_BMP, // BMP (Windows and OS/2 bitmap) images, always supported
	IFF_NUM_FORMATS // Indicator for the end of the list of formats
	};
