...
Blind::Blind(const char* sName,Container* sParent,GLfloat preferredWidth,GLfloat preferredHeight,bool sManageChild)
	:Widget(sName,sParent,false),preferredSize(preferredWidth,preferredHeight,0.0f)
	{
	/* Manage me: */
	if(sManageChild)
		manageChild();
