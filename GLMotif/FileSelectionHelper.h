...
class FileSelectionHelper
	...
	const std::string& getDefaultFileName(void) const // Returns the current default file name
		{
		return defaultFileName;
		}
	const std::string& getExtensionFilter(void) const // Returns the current filename extension filter
		{
