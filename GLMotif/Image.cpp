...
void Image::uploadTexture(GLuint textureObjectId,bool npotdtSupported,const Texture::Size& textureSize,GLContextData& contextData) const
	{
	if(getMipmapLevel()>0)
		{
...
void Image::setImage(const Images::BaseImage& newImage,const GLfloat newResolution[2])
	{
	/* Replace the image: */
	image=newImage;
