...
class Blind:public Widget
	...
	public:
	Blind(const char* sName,Container* sParent,bool sManageChild =true);
	Blind(const char* sName,Container* sParent,GLfloat preferredWidth,GLfloat preferredHeight,bool sManageChild =true);
