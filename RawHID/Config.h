/***********************************************************************
Config - Configuration header for the RawHID library.
...
#ifndef RAWHID_CONFIG_INCLUDED
#define RAWHID_CONFIG_INCLUDED

#define RAWHID_EVENTDEVICEFILEDIR "/dev/input"
