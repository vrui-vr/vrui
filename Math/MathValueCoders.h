...
template <>
class ValueCoder<Math::Rational>
	{
	/* Methods: */
	public:
	static std::string encode(const Math::Rational& value);
	static Math::Rational decode(const char* start,const char* end,const char** decodeEnd =0);
	};
